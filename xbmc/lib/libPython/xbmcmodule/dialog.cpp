...
namespace PYXBMC
{
  ...
  PyObject* Dialog_Browse(PyObject *self, PyObject *args)
  {
    ...
    {
      if (enableMultiple)
        CGUIDialogFileBrowser::ShowAndGetFileList(localShares, utf8Line[2], utf8Line[0], valuelist, 0 != useThumbs, 0 != useFileDirectories);
      else
    ...
    {
      if (enableMultiple)
        CGUIDialogFileBrowser::ShowAndGetImageList(localShares, utf8Line[0], valuelist);
      else
