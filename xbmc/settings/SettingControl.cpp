...
{
  if (StringUtils2::EqualsNoCase(strType, "toggle"))
    m_type = SettingControlTypeCheckmark;
  else if (StringUtils2::EqualsNoCase(strType, "spinner"))
    m_type = SettingControlTypeSpinner;
  else if (StringUtils2::EqualsNoCase(strType, "edit"))
  {
...
{
  if (StringUtils2::EqualsNoCase(strFormat, "boolean"))
    m_format = SettingControlFormatBoolean;
  else if (StringUtils2::EqualsNoCase(strFormat, "string"))
    m_format = SettingControlFormatString;
  else if (StringUtils2::EqualsNoCase(strFormat, "integer"))
    m_format = SettingControlFormatInteger;
  else if (StringUtils2::EqualsNoCase(strFormat, "number"))
    m_format = SettingControlFormatNumber;
  else if (StringUtils2::EqualsNoCase(strFormat, "ip"))
    m_format = SettingControlFormatIP;
  else if (StringUtils2::EqualsNoCase(strFormat, "md5"))
    m_format = SettingControlFormatMD5;
  else if (StringUtils2::EqualsNoCase(strFormat, "path"))
    m_format = SettingControlFormatPath;
  else if (StringUtils2::EqualsNoCase(strFormat, "addon"))
    m_format = SettingControlFormatAddon;
  else if (StringUtils2::EqualsNoCase(strFormat, "action"))
...
{
  std::vector<std::string> attributeList = StringUtils2::Split(strAttributes, ",");
  ...
  {
    if (StringUtils2::EqualsNoCase(*attribute, "hidden"))
      controlAttributes |= (int)SettingControlAttributeHidden;
    else if (StringUtils2::EqualsNoCase(*attribute, "new"))
